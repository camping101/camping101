...
import com.camping101.beta.camp.dto.campdetaildto.CampLogInCamp;
import com.camping101.beta.camp.dto.campdetaildto.QCampLogInCamp;
import com.camping101.beta.camp.dto.campdetaildto.SiteInCamp;
...
public class CampQueryService {
    ...
    private CampDetailsResponse findCamp(Long campId) {
        ...
        return em.createQuery(
                "select new com.camping101.beta.camp.dto.campdetaildto.CampDetailsResponse("
                    + "c.campId,"
                    + "c.name,"
                    + "c.intro,"
                    + "c.manageStatus,"
    ...
    private List<SiteInCamp> findSite(Long campId, Pageable sitePageable) {
        ...
        return em.createQuery(
                "select new com.camping101.beta.camp.dto.campdetaildto.SiteInCamp("
                    + "s.siteId,"
                    + "s.name,"
                    + "s.rpImage,"
                    + "s.introduction,"
