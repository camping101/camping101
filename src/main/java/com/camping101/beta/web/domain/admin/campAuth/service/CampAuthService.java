...
import com.camping101.beta.web.domain.admin.campAuth.dto.CampAuthListResponse;
import com.camping101.beta.db.type.CampAuth;
import com.camping101.beta.web.domain.admin.campAuth.exception.CampAuthException;
...
import com.camping101.beta.web.domain.admin.campAuth.exception.ErrorCode;
...
//        Camp findCamp = findCampAuth.getCamp();
        ...
        CampAuth findCampAuth = campAuthRepository.findByCampAuthId11(campAuthId).orElseThrow(() -> {
                throw new CampAuthException(ErrorCode.CAMP_AUTH_NOT_FOUND);
            });
