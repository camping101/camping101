...
import com.camping101.beta.web.domain.admin.member.service.AdminMemberSignInService;
...
public class AdminMemberSignInController {
    ...
    private final AdminMemberSignInService adminMemberSignInService;
    ...
    public ResponseEntity<Void> emailSignIn(@RequestBody SignInByEmailRequest request,
        ...
        TokenInfo tokenInfo = adminMemberSignInService.signInByEmail(request);
