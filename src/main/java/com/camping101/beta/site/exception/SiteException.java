package com.camping101.beta.site.exception;
...
public class SiteException extends RuntimeException{
    ...
    public SiteException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace, ErrorCode errorCode) {
